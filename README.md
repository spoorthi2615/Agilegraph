...
- **Mathematically Verified:** Over 40 diverse repositories, AgileGraph achieves a statistically significant Macro-F1 of **0.853** via its Full Model (w/ Heuristic) formulation, definitively defeating random noise baselines ($p < 10^{-22}$ via McNemar's Test).

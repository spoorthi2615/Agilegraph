...
class CBOMComparator:
    ...
    """
    def compare(self, cbom_inventory: CBOMInventory, discovered_assets: List[CBOMAsset]) -> CBOMComparison:
        """
        ...
        for asset_id, c_asset in cbom_map.items():
            if asset_id in disc_map:
                ...
                if c_asset.algorithm != d_asset.algorithm:
                    mismatches['algorithm'] = {'cbom': c_asset.algorithm, 'discovered': d_asset.algorithm}
                ...
                if c_asset.key_size and d_asset.key_size and c_asset.key_size != d_asset.key_size:
                    mismatches['key_size'] = {'cbom': c_asset.key_size, 'discovered': d_asset.key_size}

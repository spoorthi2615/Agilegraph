    ...
    def generate(results: List[FleissResult], output_dir: str):
        ...
        with open(csv_path, "w", newline="", encoding="utf-8") as f:
            ...
            for res in results:
                writer.writerow(
                    [
                        res.number_of_assets,
                        res.number_of_experts,
        ...
        with open(md_path, "w", encoding="utf-8") as f:
            ...
            f.write(
                "| Assets | Experts | Obs. Agree (P̄) | Exp. Agree (P̄e) | Kappa (κ) | Interpretation |\n"
            )
            f.write("| :--- | :--- | :--- | :--- | :--- | :--- |\n")
            for res in results:
                f.write(
                    f"| {res.number_of_assets} | {res.number_of_experts} | {res.observed_agreement:.4f} | {res.expected_agreement:.4f} | {res.kappa_score:.4f} | **{res.interpretation}** |\n"
                )

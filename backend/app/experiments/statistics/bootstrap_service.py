...
class BootstrapService:
    ...
    def estimate_confidence_interval(self, metric_name: str, data: List[float]) -> ConfidenceInterval:
        """
        ...
        """
        if not data:
            raise ValueError(f"Cannot compute confidence interval for {metric_name}: data is empty.")
    ...
    def estimate_experiment_intervals(self, experiment_name: str, metrics_data: Dict[str, List[float]]) -> ConfidenceIntervalResult:
        """

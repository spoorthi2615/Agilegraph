...
class ExplainerConfig(BaseModel):
    ...
    threshold: float = Field(default=0.5, description="Threshold for determining important edges and features.")
    return_type: str = Field(default="log_prob", description="The return type of the GNN model (log_prob, prob, raw).")

...
class CheckpointManager:
    ...
    def save_checkpoint(self, model: torch.nn.Module, optimizer: torch.optim.Optimizer, epoch: int, val_loss: float, filename: str = "gatv2_best.pt"):
        """
    ...
    def load_checkpoint(self, model: torch.nn.Module, optimizer: torch.optim.Optimizer, filename: str = "gatv2_best.pt"):
        """
        ...
        logging.info(f"Checkpoint loaded from {path} (Epoch: {checkpoint['epoch']}, Val Loss: {checkpoint['val_loss']:.4f})")

...
class ModelConfig(BaseModel):
    ...
    hidden_dimension: int = Field(default=64, description="Dimensionality of hidden tensor representations")
    output_dimension: int = Field(default=1, description="Dimensionality of the final prediction (e.g., 1 for regression/binary)")
    attention_heads: int = Field(default=4, description="Number of parallel multi-head attention mechanisms")

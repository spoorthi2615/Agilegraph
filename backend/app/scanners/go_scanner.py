...
GO_API_MAPPING: Dict[str, Tuple[AssetType, str]] = {
    ...
    "crypto/md5": (AssetType.HASH_FUNCTION, "MD5"),
    "crypto/sha1": (AssetType.HASH_FUNCTION, "SHA-1"),
    "crypto/sha256": (AssetType.HASH_FUNCTION, "SHA-256"),
    ...
    "crypto/hmac": (AssetType.MAC_FUNCTION, "HMAC"),
    "crypto/tls": (AssetType.PROTOCOL, "TLS"),
    "crypto/x509": (AssetType.CERTIFICATE, "X.509"),
    "crypto/rand": (AssetType.RANDOM_NUMBER_GENERATOR, "PRNG"),
    "golang.org/x/crypto": (AssetType.LIBRARY, "golang.org/x/crypto"),
}

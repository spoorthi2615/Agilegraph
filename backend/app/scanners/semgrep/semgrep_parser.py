        ...
        try:
            ...
            for res in raw_output["results"]:
                try:
                    ...
                    language = "unknown"
                    if file_path_node:
                        if file_path_node.endswith(".py"):
                            language = "python"
                        elif file_path_node.endswith(".java"):
                            language = "java"
                        elif file_path_node.endswith(".go"):
                            language = "go"
                        elif file_path_node.endswith(".ts") or file_path_node.endswith(".js"):
                            language = "javascript"

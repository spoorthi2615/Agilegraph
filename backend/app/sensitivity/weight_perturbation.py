...
class WeightPerturbator:
    ...
    def generate_single_weight_perturbations(
        self, baseline_weights: Dict[str, float], scales: List[float]
    ) -> List[PerturbationPayload]:
        payloads = []
    ...
    def generate_all_weights_perturbations(
        self, baseline_weights: Dict[str, float], scales: List[float]
    ) -> List[PerturbationPayload]:
        payloads = []
        for scale in scales:

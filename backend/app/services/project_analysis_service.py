...
class ProjectAnalysisService:
    ...
    def analyze_project(self, project_id: str, project_path: Path) -> ProjectAnalysisResult:
        ...
        detected_languages: List[DetectedLanguage] = LanguageDetectionService.detect_languages(project_path)
        ...
        scanner_results = self.scanner_manager.execute_all(project_path, target_languages=target_languages)

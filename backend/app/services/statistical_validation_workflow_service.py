...
class StatisticalValidationWorkflowService:
    ...
    @classmethod
    def generate_report(
        cls, validations: List[ExpertValidation], reliability_threshold: float = 0.60
        ...
        if not validations:
            raise ValueError(
                "Cannot generate a macroscopic statistical report on an empty list of validations."
            )
        ...
        for node_id, node_validations in grouped_validations.items():
            ...
            if num_experts == 2:
                ...
                result = InterRaterReliabilityService.calculate_kappa(
                    node_validations[0], node_validations[1]
                )
        ...
        return StatisticalValidationReport(
            ...
            summary=summary,
            metadata={"high_reliability_threshold": reliability_threshold},
        )

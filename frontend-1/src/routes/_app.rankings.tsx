...
import { assets, riskColor, type RiskLevel } from "@/lib/mock-data";
...
function Rankings() {
  ...
  return (
    <>
      <AppTopbar title="Risk Rankings" subtitle={`${rows.length} of ${assets.length} assets`}

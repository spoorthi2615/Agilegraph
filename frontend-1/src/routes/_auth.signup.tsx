...
function SignUp() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Depending on Supabase settings, they might be logged in automatically if email confirm is disabled
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Enter your details below to get started with AgileGraph.
        </p>
      </div>
